...
class CodeNotEqualsTest {
    ...
    @Test
    fun checkCodeNotEquals() {
        response.shouldBe(Condition.codeNotEquals(400))
    }

    @Test
    fun checkNegativeCodeNotEquals() {
        assertFails { response.shouldBe(Condition.codeNotEquals(200)) }
    }
}
